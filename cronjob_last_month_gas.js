...
// curl -X POST -H 'Accept: application/json' -G http://localhost:8086/query?pretty=true -u admin:admin --data-urlencode "db=emsdb" --data-urlencode "q=select difference(*) from (SELECT  (mean(\"meter151/GasUsage1\")+ mean(\"meter151/GasUsage2\")+ mean(\"meter151/GasUsage3\")+ mean(\"meter151/GasUsage4\")+ mean(\"meter151/GasUsage5\")+ mean(\"meter151/GasUsage6\")+ mean(\"meter151/GasUsage7\")+ mean(\"meter151/GasUsage8\")+ mean(\"meter151/GasUsage9\")+ mean(\"meter151/GasUsage10\")+ mean(\"meter151/GasUsage12\")+ mean(\"meter151/GasUsage13\")+ mean(\"meter151/GasUsage14\")+ mean(\"meter151/GasUsage15\")+ mean(\"meter151/GasUsage16\")) as mean  FROM data  WHERE time > now() - 1d GROUP BY time(1d) fill(null))"
 ...
 async function callFetch(){
    ...
    await fetch("http://localhost:8086/query?pretty=true&db=emsdb&q=SELECT (mean(\"meter151/GasUsage1\") %2B mean(\"meter151/GasUsage2\") %2B mean(\"meter151/GasUsage3\") %2B mean(\"meter151/GasUsage4\") %2B mean(\"meter151/GasUsage5\") %2B mean(\"meter151/GasUsage6\") %2B mean(\"meter151/GasUsage7\") %2B mean(\"meter151/GasUsage8\") %2B mean(\"meter151/GasUsage9\") %2B mean(\"meter151/GasUsage10\") %2B mean(\"meter151/GasUsage12\") %2B mean(\"meter151/GasUsage13\") %2B mean(\"meter151/GasUsage14\") %2B mean(\"meter151/GasUsage15\") %2B mean(\"meter151/GasUsage16\")) as mean  FROM data  WHERE time > now() - 30d GROUP BY time(30d) fill(null)", {
        headers: {
    ...
    .then(json => 
        {
            ...
            if (json === undefined || json === null){
                ...
                conn.query(`INSERT INTO stat_last_month_gas (created, rawData) VALUES                     
                ( now(), "${0}")`,
...
async function lastFunction(){
    ...
    await fetch("http://localhost:8086/query?pretty=true&db=emsdb&q=select difference(*) from (SELECT  (mean(\"meter151/GasUsage1\") %2B mean(\"meter151/GasUsage2\") %2B mean(\"meter151/GasUsage3\") %2B mean(\"meter151/GasUsage4\") %2B mean(\"meter151/GasUsage5\") %2B mean(\"meter151/GasUsage6\") %2B mean(\"meter151/GasUsage7\") %2B mean(\"meter151/GasUsage8\") %2B mean(\"meter151/GasUsage9\") %2B mean(\"meter151/GasUsage10\") %2B mean(\"meter151/GasUsage12\") %2B mean(\"meter151/GasUsage13\") %2B mean(\"meter151/GasUsage14\") %2B mean(\"meter151/GasUsage15\") %2B mean(\"meter151/GasUsage16\")) as mean  FROM data  WHERE time > now() - 30d GROUP BY time(30d) fill(null))", {
        headers: {
            Accept: "application/json",
            Authorization: "Basic YWRtaW46YWRtaW4="
        },
    ...
    .then(json => 
        {
            ...
            if (json === undefined || json === null){
                ...
                conn.query(`UPDATE stat_last_month_gas SET delta = "${0}" WHERE id in (select id FROM (select max(id) as id FROM stat_last_month_gas) as temp)`,
                function (error, results, fields) {
                    if (error) {
                        console.log(error);
                    }
                ...
                conn.query(`UPDATE stat_last_month_gas SET delta = "${json.results[0].series[0].values[0][1]}" WHERE id in (select id FROM (select max(id) as id FROM stat_last_month_gas) as temp)`,
                function (error, results, fields) {
                    if (error) {
                        console.log(error);
                    }
